"""Run preflight consumes the current Slurm projection and independent entitlement."""
...
from workspace107.domain.slurm_projection import SlurmFacts, SlurmProjection
...
@pytest.mark.asyncio
async def test_preflight_requires_independent_entitlement_and_slurm_facts(
